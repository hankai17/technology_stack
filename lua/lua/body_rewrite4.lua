...
local global_tag = "pr.net-east.com"
...
function test1(protocol, host, url)
    ...
    if string.find(uri, ".pr.net-east.com", 1, true) then
...
function test(protocol, host, url)
    ...
    --new_location = string.format("http://%s.%s.%s.%s%s", host, protocol, port, "pr.net-east.com", url)
    new_location = string.format("http://%s.%s.%s.%s%s", host, protocol, port, global_tag, url)
    --new_location = string.format("http://%s%s%s", "pr.net-east.com/", host, url)
    return new_location
end
...
function ifeng_gsub(protocol, host, url)
    ...
    new_location = string.format("%s//%s.%s.%s.%s%s", prefix, host, protocol, port, global_tag, url)
    return new_location
end
...
function map_baidu_rewrite(body)
    if string.match(uri, "getscript") then
        ...
        body, rep_count = string.gsub(body, "map.baidu.com\"", "map.baidu.com.http.80."..global_tag.."\"")
        body, rep_count = string.gsub(body, "maponline0.bdimg.com", "maponline0.bdimg.com.http.80."..global_tag)
        body, rep_count = string.gsub(body, "maponline1.bdimg.com", "maponline1.bdimg.com.http.80."..global_tag)
        body, rep_count = string.gsub(body, "maponline2.bdimg.com", "maponline2.bdimg.com.http.80."..global_tag)
        body, rep_count = string.gsub(body, "maponline3.bdimg.com", "maponline3.bdimg.com.http.80."..global_tag)

        body, rep_count = string.gsub(body, "api0.map.bdimg.com", "api0.map.bdimg.com.http.80."..global_tag)
        body, rep_count = string.gsub(body, "api1.map.bdimg.com", "api1.map.bdimg.com.http.80."..global_tag)
        body, rep_count = string.gsub(body, "api2.map.bdimg.com", "api2.map.bdimg.com.http.80."..global_tag)
        body, rep_count = string.gsub(body, "api3.map.bdimg.com", "api3.map.bdimg.com.http.80."..global_tag)
        return body
    end
    body, rep_count = string.gsub(body, "maponline0.bdimg.com", "maponline0.bdimg.com.http.80."..global_tag)
    body, rep_count = string.gsub(body, "maponline1.bdimg.com", "maponline1.bdimg.com.http.80."..global_tag)
...
function topway_rewrite(body)
    ...
    if string.match(uri, "leftsidebar") then -- 我们只修改某个特征的url
        body, rep_count = string.gsub(body, "https://speed.topway.cn", "http://speed.topway.cn.https.443."..global_tag)
    end
...
function szmg_api_rewrite(body)
    body, rep_count = string.gsub(body, "api.szmg.com.cn", "api.szmg.com.cn.http.80."..global_tag)
    body, rep_count = string.gsub(body, "login.szmg.com.cn", "login.szmg.com.cn.http.80."..global_tag)
    return body
end

function dcs_conac_rewrite(body)
    body, rep_count = string.gsub(body, "bszs.conac.cn", "bszs.conac.cn.http.80."..global_tag)
    body, rep_count = string.gsub(body, "dcs.conac.cn", "dcs.conac.cn.http.80."..global_tag)
    return body
end

function ioa_lib_rewrite(body)
    body, rep_count = string.gsub(body, "6415hr.portal.chaoxing.com", "6415hr.portal.chaoxing.com.http.80."..global_tag)
    ...
    if string.match(uri, "all%-request") then -- 我们只修改某个特征的url <img src=\"//p.ananas.chaoxing.com
        ...
        body, rep_count = string.gsub(body, "(http.?)://([^/\n%s>\\\"']+)([^\n%s>\\\"']*[\n%s>\\\"'])", test)
        body, rep_count = string.gsub(body, "p.ananas.chaoxing.com", "p.ananas.chaoxing.com.http.80."..global_tag)

        -- "https:\\/\\/mp.weixin.qq.com\\/s?__biz=MzIxNzg1NDg0Nw==\\u0
        body, rep_count = string.gsub(body, "https:\\\\/\\\\/mp.weixin.qq.com", "http:\\\\/\\\\/mp.weixin.qq.com.https.443."..global_tag)
