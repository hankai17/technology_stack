...
void foo() {
    ...
    count0 = std::count_if(values.begin(), values.end(), std::bind2nd(std::less<int>(), 5));
    count1 = std::count_if(values.begin(), values.end(), boost::bind(std::less<int>(), _1, 5));
    assert(count0 == count1);
    ...
    count1 = std::count_if(str_values.begin(), str_values.end(), boost::bind(std::less<std::size_t>(), boost::bind(&std::string::size, _1), 5));
    assert(2 == count1);
